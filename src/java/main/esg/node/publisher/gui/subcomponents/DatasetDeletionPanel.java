 ...
 * Copyright (C) 2010 Lawrence Livermore National Laboratory.
 */
public class DatasetDeletionPanel  extends JPanel implements MouseListener, ActionListener {


    JPanel mainPanel = new JPanel(new SpringLayout());
    private static String name = "Data Deletion";

    public DatasetDeletionPanel() {
    ...
    private void buildPanel() {
        ...
        two.add(new JLabel("Dataset Deletion"));
        JButton two_b = new JButton("Remove");
